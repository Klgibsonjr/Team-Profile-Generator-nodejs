const managerQuestions = [
  ...
  },
  {
    ...
    validate: (res) => {
      if (isNaN(res)) return 'Please enter a valid employee ID number';
      else return true;
    },
  },
  {
  ...
  },
  {
    ...
    validate: (res) => {
      if (isNaN(res)) return 'Please enter a valide office number.';
      else return true;
    },
  },
];
...
const engineerQuestions = [
  {
    ...
    validate: (res) => {
      if (res) return true;
      if (!res) return "Please enter a engineer's name.";
    },
  },
  {
    type: 'input',
...
const internQuestions = [
  {
    ...
    validate: (res) => {
      if (res) return true;
      if (!res) return "Please enter a intern's name.";
    },
  },
  {
    type: 'input',
